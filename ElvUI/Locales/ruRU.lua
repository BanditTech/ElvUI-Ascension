...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/Ascension-Addons/ElvUI"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://github.com/Ascension-Addons/ElvUI"
L["ElvUI is out of date. You can download the newest version from https://github.com/Ascension-Addons/ElvUI"] = "ElvUI устарел. Вы можете скачать последнюю версию с https://github.com/Ascension-Addons/ElvUI"
