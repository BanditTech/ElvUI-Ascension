...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/Ascension-Addons/ElvUI"] = "ElvUI 已過期超過5個版本. 你可以在 https://github.com/Ascension-Addons/ElvUI 下載到最新的版本."
L["ElvUI is out of date. You can download the newest version from https://github.com/Ascension-Addons/ElvUI"] = "ElvUI 已過期. 你可以在 https://github.com/Ascension-Addons/ElvUI 下載到最新的版本."
